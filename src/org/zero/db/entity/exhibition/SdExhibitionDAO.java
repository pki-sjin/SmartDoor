 ...
 * SdExhibition entities. Transaction control of the save(), update() and
...
public class SdExhibitionDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(SdExhibitionDAO.class);
	// property constants
	...
	public SdExhibition findById(java.lang.Integer id) {
		...
		try {
			SdExhibition instance = (SdExhibition) getSession().get(
					"org.zero.db.entity.exhibition.SdExhibition", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(SdExhibition instance) {
		...
		try {
			List results = getSession().createCriteria(
					"org.zero.db.entity.exhibition.SdExhibition").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding SdExhibition instance with property: "
	...
	public SdExhibition merge(SdExhibition detachedInstance) {
		...
		try {
			SdExhibition result = (SdExhibition) getSession().merge(
					detachedInstance);
